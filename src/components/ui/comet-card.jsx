...
export const CometCard = ({
  ...
  return (
    <div className={cn("perspective-distant transform-3d my-3 md:my-6", className)}>
      <motion.div
        ref={ref}
        ...
        style={{
          ...
          translateY,
          boxShadow:
            "rgba(0, 0, 0, 0.01) 0px 0px 0px 0px, rgba(0, 0, 0, 0.02) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 0px 0px 0px, rgba(0, 0, 0, 0.1) 0px 15px 20px 0px",
        }}
        initial={{ scale: 1, z: 0 }}
        whileHover={{
          scale: 1.05,
